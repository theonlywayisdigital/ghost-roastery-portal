...
export function RoastLogForm({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    router.push("/inventory/roast-log");
    router.refresh();
  }
  ...
  async function handleDelete() {
    ...
    if (res.ok) { router.push("/inventory/roast-log"); router.refresh(); }
  }

  return (
    <div>
      <div className="flex items-center gap-3 mb-6">
        <Link href="/inventory/roast-log" className="p-2 text-slate-400 hover:text-slate-600 rounded-lg hover:bg-slate-100 transition-colors">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-green-900">
                  ...
                  <Link href={`/inventory/roasted/${stockAddition.roasted_stock_id}`} className="text-brand-600 hover:text-brand-700 underline">
        ...
        <div className="flex items-center gap-3 pt-2">
          ...
          <Link href="/inventory/roast-log" className="px-4 py-2.5 text-sm text-slate-600 hover:text-slate-800 transition-colors">Cancel</Link>
        </div>
      </form>
    </div>
  );
