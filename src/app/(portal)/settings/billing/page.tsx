  ...
  return (
    <BillingPage
      roaster={{
        ...
        address_line_1: (user.roaster.address_line_1 as string) || "",
        address_line_2: (user.roaster.address_line_2 as string) || "",
        ...
        sales_tier: (user.roaster.sales_tier as string) || "growth",
        marketing_tier: (user.roaster.marketing_tier as string) || "growth",
        ...
        trial_started_at: (user.roaster.trial_started_at as string) || null,
        trial_ends_at: (user.roaster.trial_ends_at as string) || null,
        trial_used: (user.roaster.trial_used as boolean) ?? false,
