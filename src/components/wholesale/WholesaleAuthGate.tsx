...
export function WholesaleAuthGate({
  ...
  // State 1: Not authenticated — show login form
        ...
        <div className="max-w-md mx-auto">
          <div className="bg-white rounded-xl border border-slate-200 p-8 text-center">
            ...
            <p className="text-slate-500">
              Your trade account application is currently being reviewed.
      ...
      return (
        <div className="max-w-md mx-auto">
          <div className="bg-white rounded-xl border border-slate-200 p-8 text-center">
            ...
            <p className="text-slate-500">
              Unfortunately your trade account application was not approved at
